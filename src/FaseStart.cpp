...
void FaseStart::init()
{
	heroMove1 = new ObjetoDeJogo("Hero1",SpriteAnimado("rsc/princesa_inicio.anm",2,COR::ROSA),27,30);
	objs.push_back(heroMove1);
	
	heroMove2 = new ObjetoDeJogo("Hero2",SpriteAnimado("rsc/princesa_inicio2.img",4,COR::ROSA),27,58);
